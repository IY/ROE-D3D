...
int aimheight = 3;				//aim height value, high value aims higher 3 para trinta (sanduk)
...
void AddWeapons(LPDIRECT3DDEVICE9 Device)
{
	...
	D3DXVECTOR3 pOut, pIn(0.0f, (float)aimheight, 0);
...
char *opt_Keys[] = { (PCHAR)"[OFF]", (PCHAR)"[XButton2]", (PCHAR)"[RMouse]", (PCHAR)"[LMouse]", (PCHAR)"[Ctrl]", (PCHAR)"[Alt]", (PCHAR)"[Space]", (PCHAR)"[X]", (PCHAR)"[C]" };
